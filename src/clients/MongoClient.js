...
var getConnectionString_1 = require("../helpers/getConnectionString");
var mongoose_1 = require("mongoose");
var MongoClient = /** @class */ (function () {
    function MongoClient(logger) {
        this.logger = logger;
    }
    MongoClient.prototype.connect = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, mongoose_1["default"].connect(getConnectionString_1.getConnectionString(), {
    ...
    MongoClient.prototype.disconnect = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
